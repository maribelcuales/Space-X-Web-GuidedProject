...
import { fetchMissions as mockFetchMissions, fetchMissions } from './api/fetchMissions'; 
...
test('renders mission data when Get Data button is clicked', async () => {
  ...
  // to console log all the query functions 
  ...
  // assert that our missions are being rendered 
